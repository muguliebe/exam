...
@Configuration
@EnableJpaRepositories(basePackages = ["com.exam.bank.repo.jpa"],
...
class PublicDataSource {
    ...
    fun dataSource(): DataSource {
        ...
        ds.jdbcUrl = "jdbc:postgresql://localhost:62501/postgres?ssl=false&charset=utf8"
    ...
    fun entityManagerFactory(
            @Qualifier("emPublicDataSource") dataSource: DataSource
